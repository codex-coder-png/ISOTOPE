...
(function () {
  ...
  function createLobby(mode, maxPlayers, pvpTargetKills, friendlyFire) {
    ...
    lobbyConfig = { mode: mode || 'coop', maxPlayers: Math.min(4, Math.max(2, maxPlayers || 2)), pvpTargetKills: pvpTargetKills || 10, friendlyFire: !!friendlyFire };
    myElement = SAVE.sel || '1';
    isReady = true;
  ...
  Object.assign(NET, {
    ...
    sendChat, startGame, sendClientInput, sendClientAction, broadcastSnapshot, reset,
